                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('profile_picture') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="profile_picture" type="file" class="form-control" name="profile_picture" value="{{ old('profile_picture') }}">
                        ...
                        <div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="male" type="radio" class="col-md-2" name="gender" value="male">
                                <label for="female" class="col-md-2">Female</label>
                                <input id="female" type="radio" class="col-md-2" name="gender" value="female">
                                <br>
